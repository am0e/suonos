...
public class ImageDimensions {
    ...
    public ImageDimensions(Path file) throws IOException {
        try (InputStream is = Files.newInputStream(file)) {
            processStream(is);
        }
    }

    public ImageDimensions(InputStream is) throws IOException {
        processStream(is);
    }

    public ImageDimensions(byte[] bytes) throws IOException {
    ...
    public String toString() {
        return Msgs.format("MIME Type: {}, Width: {}, Height: {}", mimeType, width, height);
    }
}
